                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                   <div className="flex items-start gap-3 p-4 bg-emerald-500/5 rounded-xl border border-emerald-500/10">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">{listing.llm_analysis?.pros?.join(', ') || 'Analiza w toku...'}</p>
                      </div>
                   </div>
                   <div className="flex items-start gap-3 p-4 bg-amber-500/5 rounded-xl border border-amber-500/10">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">{listing.llm_analysis?.cons?.join(', ') || 'Analiza w toku...'}</p>
                      </div>
                   </div>
                </div>
             </div>
