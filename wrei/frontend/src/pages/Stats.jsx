               ...
               <tbody className="divide-y divide-slate-700/50">
                  {districts.map((d) => (
                     ...
                     >
                        ...
                        <td className="px-6 py-4 text-right text-slate-300">{Math.round(d.median).toLocaleString()} zł</td>
                        <td className="px-6 py-4 text-right text-slate-300">{Math.round(d.avg).toLocaleString()} zł</td>
